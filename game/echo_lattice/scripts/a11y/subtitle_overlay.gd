...
const STUB_LINES := {
	...
	"pa.rewrite.second_birth": "Both axes remember you.",
	"habit.op.deflector": "Corridor sealed.",
	"habit.op.fossilize": "Loop calcified.",
	"habit.op.thicken": "Walk thickened underfoot.",
	"habit.op.grow": "Far margin darkens.",
	"habit.op.carve": "A hairline door opens.",
	"habit.op.widen": "The corridor breathes.",
