...
| Doc | Topic |
|---|---|
| [`02_CORE_LOOP.md`](02_CORE_LOOP.md) | Survey → Recover → Bind → Tension → Inhabit → Residue |
| [`03_FRAGMENTS.md`](03_FRAGMENTS.md) | Atomic craft units (no purple Time cliché) |
| [`04_THREADS.md`](04_THREADS.md) | Typed relations |
| [`05_STRUCTURES.md`](05_STRUCTURES.md) | Seated graphs that rewrite place |

### 06–08 — World / economy / legacy
...
| Doc | Topic |
|---|---|
| [`12_MULTIPLAYER.md`](12_MULTIPLAYER.md) | MVP singleplayer; social residue fence |
| [`13_MONETIZATION.md`](13_MONETIZATION.md) | Premium paid band |
...
### 20+ — Systems expansions

| Doc | Topic |
|---|---|
| [`24_STRUCTURE_ECOLOGY.md`](24_STRUCTURE_ECOLOGY.md) | Beacon / Recorder / Gateway classes + adaptation rules |
...
| Branch | PR |
|---|---|
| `cursor/weaver-pivot` | [#166](https://github.com/cmp07/Game-/pull/166) |
| `cursor/weaver-01-concept` | [#165](https://github.com/cmp07/Game-/pull/165) |
| `cursor/weaver-systems-core` | [#169](https://github.com/cmp07/Game-/pull/169) |
| `cursor/weaver-world-econ` | [#171](https://github.com/cmp07/Game-/pull/171) |
...
| `cursor/weaver-ecology` | Structure ecology (`24`) |
