...
Longevity patterns (one verb, soft goals, readable physics, etc.): [`EASY_START_DEEP_MASTERY.md`](EASY_START_DEEP_MASTERY.md).

---

## Name resolutions

| Fuzzy | Resolved | Steam |
|---|---|---|
| Raccoin / rack a coin | RACCOIN: Coin Pusher Roguelike | https://store.steampowered.com/app/3784030/RACCOIN_Coin_Pusher_Roguelike/ |
