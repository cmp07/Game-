...
![Rewrite slam](01_hook_rewrite_slam.png)
...
Open Field Ledger folio: verso brand + wide rectangular letterpress seal above a dense habit maze (no circle die / no hollow cream band); recto Field Index with compact ~38px action pitch and a single date·EL meta line. Spine kills the dead center void. No chamber BUFFER / Move chrome.

## 03 — Chamber start

![Chamber start](03_chamber_start.png)

Quiet Span clean read: ink walls, copper goal, habit sealed, empty BUFFER strip.

## 04 — Walking trail

![Walking trail](04_walking_trail.png)

Mirror Birth chalk trail writing toward a checkpoint — “Floor chalk noted.” before the slam.

## 05 — Mid-act pressure

![Mid-act chamber](05_mid_act_chamber.png)

Cement Trail under the same ledger margins; habit unwritten, paper plate framing.

## 06 — Win / stars

![Win stars](06_win_stars.png)
