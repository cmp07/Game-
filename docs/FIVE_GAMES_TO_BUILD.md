...
|---|---|---|
| **First (LOCKED)** | **Echo Lattice** | Production locked Aug 2026 — see `docs/ECHO_LATTICE/00_PRODUCTION_BIBLE.md` |
...
## Decision gate — CLOSED for Game 1

**LOCKED (August 2026):** Game 1 = **Echo Lattice**.

Production constitution: [`docs/ECHO_LATTICE/00_PRODUCTION_BIBLE.md`](ECHO_LATTICE/00_PRODUCTION_BIBLE.md) · index: [`docs/GAME_PLAN.md`](GAME_PLAN.md).

Games 2–5 below remain the approved catalog for later separate Steam SKUs. Do not reopen the gate by scaffolding a different Game 1 without an explicit production unlock.

Historical options (superseded for Game 1):

1. ~~Echo Lattice (recommended systems-first)~~ → **LOCKED**  
2. Edgewright — Game 2 catalog  
3. Quench — Game 3 catalog  
4. Black Plinth — Game 4 catalog  
5. Stillroom — Game 5 / wildcard short  
6. Alternates (e.g. Residue) — separate one-pager only; still pure; still not a mashup into Echo Lattice.
